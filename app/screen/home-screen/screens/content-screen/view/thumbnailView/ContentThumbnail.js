...
var ContentThumbnail = React.createClass({
    ...
    render: function () {
        ...
        return (
            <div className="PIMThumbContainer" title={productTitle} data-product-id={product.id} key={product.id}
                 data-type={product.type} data-workflow-status={product.workflowStatus}>
